            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <Link
                  ...
                  className="p-6 bg-gradient-to-br from-amber-50 to-white rounded-2xl border border-amber-100 hover:from-amber-100 hover:to-white transition-all cursor-pointer"
                >
                  ...
                  <h4 className="font-bold text-gray-900 mb-2">Demande personnalisée</h4>
