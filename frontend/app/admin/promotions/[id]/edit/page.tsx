...
export default function EditPromotionPage() {
  ...
  const loadData = async () => {
    try {
      const [promotionRes, companiesRes, productsRes, categoriesRes] = await Promise.all([
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await promotionsApi.update(id, data);
    ...
    <AdminLayout>
      ...
      <div className="mb-8">
        ...
        >
          ...
          Retour au détail de la promotion
        </Link>
        <h1 className="text-4xl font-black text-gray-900">Modifier la promotion</h1>
        <p className="text-gray-600 mt-2">Modifier les informations de la promotion</p>
      </div>
