        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="tel:+352691775623" className="w-10 h-10 bg-white/10 hover:bg-green-600 rounded-lg flex items-center justify-center transition-all backdrop-blur-sm border border-white/20">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </a>
              <a href="mailto:contact@rcmplay-reparation.lu" className="w-10 h-10 bg-white/10 hover:bg-green-600 rounded-lg flex items-center justify-center transition-all backdrop-blur-sm border border-white/20">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Informations */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-green-400">INFORMATIONS</h3>
          ...
          {/* Pages */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-green-400">PAGES</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-green-400">SERVICES</h3>
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              Copyright {new Date().getFullYear()} <span className="text-green-400 font-semibold">RCMPLAY-REPARATION</span>© Luxembourg
            </p>
